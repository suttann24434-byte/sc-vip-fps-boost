...
--// Fitur: Intro GUI + Sound + Key System + Auto Save per Device + FPS Boost
...
FPSButton.Position = UDim2.new(0.3,0,0.8,0)
FPSButton.Size = UDim2.new(0.4,0,0.15,0)
...
Notif.Position = UDim2.new(0,0,0.95,0)
Notif.Text = ""

--// Loader.lua - SuttannHub vStable Full
--// Fitur: Intro GUI + Sound + Key System + FPS Boost + Toggle GUI
...
-- Sounds (ganti sesuai sound kamu)
local Ambient = Instance.new("Sound", IntroFrame)
Ambient.SoundId = "rbxassetid://5410086212"  -- ganti ID kamu
Ambient.Volume = 0.6
Ambient.Looped = true
Ambient:Play()
...
if HasAccess() then
    ...
    -- FPS Boost Button di loader
    local FPSButton = Instance.new("TextButton", Frame)
    FPSButton.Position = UDim2.new(0.3,0,0.5,0)
    FPSButton.Size = UDim2.new(0.4,0,0.1,0)
    ...
    local UICornerFPS = Instance.new("UICorner", FPSButton)
            ...
            local function CreateFPSGui()
                ...
                ToggleBtn.MouseButton1Click:Connect(function()
                    ...
                    if FPSEnabled then
                        ...
                        _G.Settings.Meshes = _G.Settings.Meshes or {}
                        _G.Settings.Meshes.LowDetail = true
                        _G.Settings.Images = _G.Settings.Images or {}
                        _G.Settings.Images.Invisible = true
                        _G.Settings["No Particles"] = true
                        _G.Settings["No Shadows"] = true
                        _G.Settings["Low Rendering"] = true
                    else
                        ToggleBtn.Text = "⚡ FPS Boost OFF"
                        _G.Settings = {}
                    end
                end)
            end
            task.spawn(CreateFPSGui)
        else
